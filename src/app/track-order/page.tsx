...
import { Search, Package, Truck, CheckCircle, Home, Loader2 } from "lucide-react";
...
export default function TrackOrderPage() {
  ...
  // Check URL params on load (for email links)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#F3F3F3] dark:bg-[#0A0A0A] py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-center text-black dark:text-white font-sora mb-8">
          Track Your Order
        </h1>
